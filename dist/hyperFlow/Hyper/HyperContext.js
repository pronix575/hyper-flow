...
class HyperContext {
    constructor(nameOfCtx, permanentMarkerOfCtx = () => '', stopWordOfCtx = 'exit', commands = [], errorHandlerOfCtx = (cmd) => errorsGenerator_1.error(`no such a command '${chalk_1.default.blueBright(cmd)}'`, 1)) {
        this.nameOfCtx = nameOfCtx;
